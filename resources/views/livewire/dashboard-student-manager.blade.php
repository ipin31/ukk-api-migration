@if($student)
    <div class="flex flex-col md:flex-row gap-6 items-stretch">
        ...
        <div class="flex flex-col items-center gap-4 rounded-lg border border-gray-200 dark:border-gray-700 p-6 w-full md:w-1/3 h-full">
        ...
        <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-6 w-full md:w-2/3 h-full flex flex-col justify-between">
...
@else
    ...
    <div class="w-full">
        <div class="text-center mt-1">
            ...
            <p class="inline-block bg-yellow-100 text-yellow-950 dark:bg-yellow-700 dark:text-yellow-200 px-3 py-1 rounded-full text-base mt-2">
